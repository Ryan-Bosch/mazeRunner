...
execute if entity @e[tag=mr_center] if score mr_time mr_var matches 14000..22000 if score mr_day mr_var matches 1.. as @e[tag=mr_center] at @s run function maze_runner:z_internal/night

...
execute if score mr_random mr_var matches ..1500 run fill ~-7 ~49 ~-7 ~15 ~49 ~15 bedrock

# Arctic spawner
execute if score mr_random mr_var matches 1..100 run place template mr_maze_arctic_spawner ~ ~-1 ~
execute if score mr_random mr_var matches 1..100 run loot insert ~5 ~3 ~5 loot maze_runner:chests/mr_spawner
...
execute if score mr_random mr_var matches 1..100 run loot insert ~5 ~3 ~5 loot maze_runner:chests/mr_nether_spawner
...
execute if score mr_random mr_var matches 1..100 run loot insert ~5 ~3 ~5 loot maze_runner:chests/mr_pillager_spawner
...
execute if score mr_random mr_var matches 1..100 run loot insert ~4 ~2 ~3 loot maze_runner:chests/mr_reward_house

# Trap
execute if score mr_random mr_var matches 901..1000 run place template mr_maze_trap_house ~ ~-1 ~
execute if score mr_random mr_var matches 1..100 run loot insert ~4 ~2 ~3 loot maze_runner:chests/mr_spawner
